...
jitterMEANs + scale_y_continuous(breaks = c(1000,5000, 10000,15000))
...
You can connect the dots as a visual aid, but I will reserve that for the plot using numerica data on the horizontal axis.
